...
client.on("guildMemberAdd", member => {
    ...
    const kanal = member.guild.channels.cache.find(r => r.id === "838907718516604942");
...
Bu Roldeki Arkadaşlarım Seninle İlgilenecektir  <@&838907718227591278> 
...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const tag = '⌭'
  const sunucu = '838907718089310274'
  const log = '838907720198783013'
  const rol = '838907718202949651'
...
client.on('message', message => {
    ...
    .setTitle('Yardım')
    .setColor('RANDOM')
    .addField('!e @etiket İsim | Yaş','Kayıt komutudur.')
    .addField('komut ismi','komut açıklama')
    .addField('komut ismi','komut açıklama')
    .addField('komut ismi','komut açıklama')
    .addField('komut ismi','komut açıklama')
    .addField('komut ismi','komut açıklama')
